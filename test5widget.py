...
class Ui_MainDialog(object):
    ...
    def retranslateUi(self, MainDialog):
        ...
        item = self.listWidget_variable1.item(0)
        item.setText(_translate("MainDialog", "T (Temperature)", None))
        item = self.listWidget_variable1.item(1)
        item.setText(_translate("MainDialog", "P (Pressure)", None))
        item = self.listWidget_variable1.item(2)
        item.setText(_translate("MainDialog", "Q, FLOW (Flow rate)", None))
        item = self.listWidget_variable1.item(3)
        item.setText(_translate("MainDialog", "Density logs (RHOB, DECA, DRHOB, ...)", None))
        item = self.listWidget_variable1.item(4)
        item.setText(_translate("MainDialog", "Imagery logs (ARI, BHTV, FMS, BI FMI, ...)", None))
        item = self.listWidget_variable1.item(5)
        item.setText(_translate("MainDialog", "PHI (Porosity)", None))
        item = self.listWidget_variable1.item(6)
        item.setText(_translate("MainDialog", "Hole caracterisation (Hole azimuth, radius, caliper, inclination, trajectry, deviation, ...)", None))
        item = self.listWidget_variable1.item(7)
        item.setText(_translate("MainDialog", "Magnetic parameters (FNOR, FX, FY, FZ, ...)", None))
        item = self.listWidget_variable1.item(8)
        item.setText(_translate("MainDialog", "V (Volume of water)", None))
        item = self.listWidget_variable1.item(9)
        item.setText(_translate("MainDialog", "Velocities and slowness logs (DTP, DTS, DTST, VP/VS)", None))
        item = self.listWidget_variable1.item(10)
        item.setText(_translate("MainDialog", "GR (Gamma Ray)", None))
        item = self.listWidget_variable1.item(11)
        item.setText(_translate("MainDialog", "Other", None))
        item = self.listWidget_variable1.item(12)
        item.setText(_translate("MainDialog", "Seismology parameters", None))
        item = self.listWidget_variable1.item(13)
        item.setText(_translate("MainDialog", "Resistivity logs (MPHI, IDPH, ILD, ILM, MSFL, LLD, LLS)", None))
        item = self.listWidget_variable1.item(14)
        item.setText(_translate("MainDialog", "Drilling parameters (drilling rate, velocity, WOH, WOB, Rate of penetration, ...)", None))
        item = self.listWidget_variable1.item(15)
        item.setText(_translate("MainDialog", "Chemical content (U, Th, O2, CH4, CO2, H2S, K, ...)", None))
        item = self.listWidget_variable1.item(16)
        item.setText(_translate("MainDialog", "Geological log (Age, Unit, Fracture, Minerals content, Petrographical description ...)", None))
        item = self.listWidget_variable1.item(17)
        item.setText(_translate("MainDialog", "Elastic properties (Young modulus, Poisson ratio, ...)", None))
        item = self.listWidget_variable1.item(18)
        item.setText(_translate("MainDialog", "Ph (pH)", None))
        ...
        item = self.listWidget_subjectStudy1.item(0)
        item.setText(_translate("MainDialog", "Hydraulics", None))
        item = self.listWidget_subjectStudy1.item(1)
        item.setText(_translate("MainDialog", "Chemistry, Tracer test", None))
        item = self.listWidget_subjectStudy1.item(2)
        item.setText(_translate("MainDialog", "Geology, Minerals", None))
        item = self.listWidget_subjectStudy1.item(3)
        item.setText(_translate("MainDialog", "Gravimetry, Gravimetric measurements", None))
        item = self.listWidget_subjectStudy1.item(4)
        item.setText(_translate("MainDialog", "Logging, Logs, Downhole methods, Drilling", None))
        item = self.listWidget_subjectStudy1.item(5)
        item.setText(_translate("MainDialog", "Magnetotellurics, MT", None))
        item = self.listWidget_subjectStudy1.item(6)
        item.setText(_translate("MainDialog", "Geodesy, InSAR", None))
        item = self.listWidget_subjectStudy1.item(7)
        item.setText(_translate("MainDialog", "Fracture caracterisation, Fracture", None))
        ...
        item.setText(_translate("MainDialog", "Seismology, Earthquakes, Seismic sources, Micro-seismicity", None))
        ...
        item = self.listWidget_projectPhase1.item(0)
        item.setText(_translate("MainDialog", "Circulation", None))
        item = self.listWidget_projectPhase1.item(1)
        item.setText(_translate("MainDialog", "Hydraulic Stimulation", None))
        item = self.listWidget_projectPhase1.item(2)
        item.setText(_translate("MainDialog", "Drilling", None))
        item = self.listWidget_projectPhase1.item(3)
        item.setText(_translate("MainDialog", "Exploration", None))
        item = self.listWidget_projectPhase1.item(4)
        item.setText(_translate("MainDialog", "Injection Test", None))
        item = self.listWidget_projectPhase1.item(5)
        item.setText(_translate("MainDialog", "Exploitation", None))
        item = self.listWidget_projectPhase1.item(6)
        item.setText(_translate("MainDialog", "Chemical stimulation", None))
        item = self.listWidget_projectPhase1.item(7)
        item.setText(_translate("MainDialog", "Production Test", None))
        ...
        item = self.listWidget_Location1.item(0)
        item.setText(_translate("MainDialog", "GPK1", None))
        item = self.listWidget_Location1.item(1)
        item.setText(_translate("MainDialog", "GPK2", None))
        item = self.listWidget_Location1.item(2)
        item.setText(_translate("MainDialog", "GPK3", None))
        item = self.listWidget_Location1.item(3)
        item.setText(_translate("MainDialog", "GPK4", None))
        item = self.listWidget_Location1.item(4)
        item.setText(_translate("MainDialog", "EPS1", None))
        item = self.listWidget_Location1.item(5)
        item.setText(_translate("MainDialog", "Soultz-sous-Forêts (67250)", None))
        item = self.listWidget_Location1.item(6)
        item.setText(_translate("MainDialog", "Upper Rhine Graben", None))
        item = self.listWidget_Location1.item(7)
        item.setText(_translate("MainDialog", "Alsace", None))
        item = self.listWidget_Location1.item(8)
        item.setText(_translate("MainDialog", "Rittershoffern (67690)", None))
        ...
        item = self.listWidget_Format1.item(0)
        item.setText(_translate("MainDialog", "CSV", None))
        item = self.listWidget_Format1.item(1)
        item.setText(_translate("MainDialog", "mSEED", None))
        item = self.listWidget_Format1.item(2)
        item.setText(_translate("MainDialog", "text", None))
        item = self.listWidget_Format1.item(3)
        item.setText(_translate("MainDialog", "SEG-Y", None))
        item = self.listWidget_Format1.item(4)
        item.setText(_translate("MainDialog", "jpeg", None))
        item = self.listWidget_Format1.item(5)
        item.setText(_translate("MainDialog", "png", None))
        item = self.listWidget_Format1.item(6)
        item.setText(_translate("MainDialog", "pdf", None))
